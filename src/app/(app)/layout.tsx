        ...
        <aside className="fixed inset-y-0 left-0 z-50 flex w-20 flex-col bg-sidebar text-sidebar-fg transition-all duration-300 ease-in-out hover:w-72 group overflow-hidden">
          <div className="flex flex-col gap-6 p-4 h-full">
            ...
            <div className="mt-auto space-y-4">
              {/* <ThemeToggle /> */}
              <div className="rounded-2xl bg-white/5 p-3 text-xs text-sidebar-muted transition-colors hover:bg-white/10 hover:text-sidebar-fg overflow-hidden whitespace-nowrap group/profile">
                <p className="font-medium uppercase tracking-wider text-sidebar-muted/80 opacity-0 w-0 group-hover:opacity-100 group-hover:w-auto transition-all duration-300">Signed In</p>
                <div className="mt-2 flex items-center gap-3">
                  <div className="h-8 w-8 min-w-[32px] rounded-full bg-accent/20 flex items-center justify-center text-accent font-bold">
                    {auth.employeeName.charAt(0)}
                  </div>
                  <div className="opacity-0 w-0 group-hover:opacity-100 group-hover:w-auto transition-all duration-300">
                ...
                <div className="mt-3 pt-3 border-t border-white/10 group-hover:opacity-100 group-hover:w-auto transition-all duration-300">
                  <div className="opacity-0 w-0 group-hover:opacity-100 group-hover:w-auto transition-all duration-300">
                    <LogoutButton />
                  </div>
                </div>
